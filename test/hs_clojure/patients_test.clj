...
(deftest test-add-patient
  (testing "Add patient"
    (let [patient {:name "John Doe" :sex "M" :date-of-birth "1990-01-01" :address "123 Main St" :social-security-number "123-45-6789"}
      ...
      (is (pos? id))
      (let [added-patient (get-patient "John Doe")]
        ...
        (when added-patient
          ...
          (is (= (:date-of-birth patient) (:date-of-birth added-patient)))
          (is (= (:address patient) (:address added-patient)))
          (is (= (:social-security-number patient) (:social-security-number added-patient))))))))
