...
(deftest add-patient-test
  (testing "Happy path: add patient"
    (let [patient {:name "John Doe" :sex "Male" :date-of-birth "1990-01-01" :address "123 Main St" :social-security-number "123-45-6789"}
...
(deftest update-patient-test
  (testing "Happy path: update patient"
    (let [patient {:name "John Doe" :sex "Male" :date-of-birth "1990-01-01" :address "123 Main St" :social-security-number "123-45-6789"}
          id (add-patient (:name patient) (:sex patient) (:date-of-birth patient) (:address patient) (:social-security-number patient))
          updated-patient {:name "Jane Doe" :sex "Female" :date-of-birth "1990-02-01" :address "456 Elm St" :social-security-number "987-65-4321"}
